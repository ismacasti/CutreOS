 ...
 * @author ismael
 */
public class SchedSRT extends SchedAlgorithm{

    public SchedSRT(LinkedList<Process> allProcess, Scheduling sched) {
...
@Override
    void tick() { 
        ...
        for(Process p: getReadyAndRunning()){
            ...
            else if(p.getRemaining_time() < shortestRemaining.getRemaining_time())
                shortestRemaining = p;
            }
